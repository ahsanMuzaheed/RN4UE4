...
{
#ifdef _WIN32
	return (uint32_t)FPlatformAtomics::InterlockedIncrement((int64*)&value);
#else
	return (uint32_t)FPlatformAtomics::InterlockedIncrement((int32*)&value);
#endif
//#ifdef _WIN32
...
{
#ifdef _WIN32
	return (uint32_t)FPlatformAtomics::InterlockedDecrement((int64*)&value);
#else
	return (uint32_t)FPlatformAtomics::InterlockedDecrement((int32*)&value);
#endif
//#ifdef _WIN32
